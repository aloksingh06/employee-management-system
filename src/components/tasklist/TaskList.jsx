...
function TaskList() {
  return (
    ...
    <div id='' className='w-full h-[60%] mt-10 py-5 flex flex-nowrap overflow-x-auto gap-5'>
        ...
        <div className='shrink-0 h-full w-[320px] bg-green-400 rounded-xl p-5'>
            <div className='flex items-center justify-between'>
                <h2 className='bg-red-500 px-3 py-1 rounded-xl text-sm'>
                    HIGH
                </h2>
        ...
        <div className='shrink-0 h-full w-[320px] bg-red-400 rounded-xl p-5'>
            <div className='flex items-center justify-between'>
                <h2 className='bg-red-500 px-3 py-1 rounded-xl text-sm'>
                    HIGH
                </h2>
        ...
        <div className='shrink-0 h-full w-[320px] bg-orange-400 rounded-xl p-5'>
            <div className='flex items-center justify-between'>
                <h2 className='bg-red-500 px-3 py-1 rounded-xl text-sm'>
                    HIGH
                </h2>
        ...
        <div className='shrink-0 h-full w-[320px] bg-blue-400 rounded-xl p-5'>
            <div className='flex items-center justify-between'>
                <h2 className='bg-red-500 px-3 py-1 rounded-xl text-sm'>
                    HIGH
                </h2>
